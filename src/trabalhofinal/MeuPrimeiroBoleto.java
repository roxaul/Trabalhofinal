...
public class MeuPrimeiroBoleto {
        ...
        public static void main(String[] args) {
            ...
            boleto boleto = new boleto("pago em qualquer local","Senhor sacado, sabemos sim que o valor " +"cobrado não é o esperado, aproveite o DESCONTÃO!","esse é um teste 1"
            ...
            cedente2 cedente2 = new cedente2("Universidade Federal de Goias",0304);
